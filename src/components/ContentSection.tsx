    ...
    <section className={styles.contentSection}>
        ...
        <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem'}}>
          ...
          <div>
            ...
            <div className={styles.topicGroup}>
              ...
              <div className={styles.topicContent}>
                <p style={{color: '#0ea5e9'}}>Special Session on Intelligent Multimodal Perception and Cognitive Engineering</p>
                <p style={{color: '#0ea5e9'}}>Special Session on Distributed AI across Edge-Cloud Continuum</p>
                <p style={{color: '#0ea5e9'}}>Special Session on 6G Non-Terrestrial Network Technologies Toward Global Coverage</p>
                <p style={{color: '#0ea5e9'}}>Special Session on Advances in Medical Imaging and Image Processing</p>
      ...
      <aside className={styles.sidebar}>
        ...
        <div className={styles.sponsorBlock}>
          ...
          <div className={styles.sponsorLogos}>
            <div className={styles.logoBox} style={{borderColor: '#0284c7'}}>IEEE Vietnam Section</div>
          </div>
        </div>
        ...
        <div className={styles.sponsorBlock}>
          ...
          <div className={styles.sponsorLogos}>
            <div className={styles.logoBox} style={{borderColor: '#0284c7'}}>IEEE Logo</div>
            <div className={styles.logoBox} style={{borderColor: '#000'}}>APS Logo</div>
            <div className={styles.logoBox} style={{borderColor: '#f97316'}}>Photonics Society Logo</div>
            <div className={styles.logoBox} style={{borderColor: '#8b5cf6'}}>KICS Logo</div>
          </div>
        </div>
        ...
        <div className={styles.sponsorBlock}>
          ...
          <div className={styles.sponsorLogos}>
            <div className={styles.logoBox} style={{borderColor: '#1d4ed8'}}>SAMSUNG</div>
          </div>
        </div>
        ...
        <div className={styles.sponsorBlock}>
          <div className={styles.sponsorLogos} style={{marginTop: '1rem'}}>
            <div className={styles.logoBox} style={{borderColor: '#334155'}}>Tektronix</div>
          </div>
        </div>
